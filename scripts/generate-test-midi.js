...
function generateCMajorScaleMIDI() {
  ...
  const track1Data = [
    ...
    '07',
    'A1',
    '20', // Set tempo (500,000 microseconds per quarter note)
    '00',
    'FF',
    '58',
    '04',
    ...
    '02',
    '18',
    '08', // Time signature (4/4)
    '00',
    'FF',
    '2F',
    '00', // End of track
  ];
  const track1 = Buffer.from(
    'MTrk' +
      '\\x00\\x00\\x00' +
      String.fromCharCode(track1Data.length) + // Track length
  ...
  const track2Data = [
    ...
    '90',
    '3C',
    '64', // Note on: C4, velocity 100
    '60',
    '80',
    '3C',
    '40', // Note off: C4, after 96 ticks
    '00',
    '90',
    '3E',
    '64', // Note on: D4, velocity 100
    '60',
    '80',
    '3E',
    '40', // Note off: D4, after 96 ticks
    '00',
    '90',
    '40',
    '64', // Note on: E4, velocity 100
    '60',
    '80',
    '40',
    '40', // Note off: E4, after 96 ticks
    '00',
    '90',
    '41',
    '64', // Note on: F4, velocity 100
    '60',
    '80',
    '41',
    '40', // Note off: F4, after 96 ticks
    '00',
    '90',
    '43',
    '64', // Note on: G4, velocity 100
    '60',
    '80',
    '43',
    '40', // Note off: G4, after 96 ticks
    '00',
    '90',
    '45',
    '64', // Note on: A4, velocity 100
    '60',
    '80',
    '45',
    '40', // Note off: A4, after 96 ticks
    '00',
    '90',
    '47',
    '64', // Note on: B4, velocity 100
    '60',
    '80',
    '47',
    '40', // Note off: B4, after 96 ticks
    '00',
    '90',
    '48',
    '64', // Note on: C5, velocity 100
    '60',
    '80',
    '48',
    '40', // Note off: C5, after 96 ticks
    '00',
    'FF',
    '2F',
    '00', // End of track
  ...
  const track2 = Buffer.from(
    'MTrk' +
      '\\x00\\x00\\x00' +
      String.fromCharCode(track2Data.length) + // Track length
...
function generateCMajorChordMIDI() {
  ...
  const track2Data = [
    ...
    '80',
    '3C',
    '40', // Note off: C4, after 192 ticks (half note)
    '00',
    '80',
    '40',
    '40', // Note off: E4
